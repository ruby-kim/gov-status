  ...
  const statusInfo = [
    {
      ...
      criteria: ['웹사이트 접속 가능', '모든 기능 정상 작동', '느려도 작동하면 정상', '오류 없음'],
    ...
    },
    {
      ...
      criteria: ['웹사이트 접속 불가', '연결 시간 초과', '서버 오류 발생', '예상치 못한 장애'],
      color: 'text-red-600',
      bgColor: 'bg-red-50',
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-700 leading-relaxed">
                  각 서비스의 상태는{' '}
                  <span className="font-medium text-gray-900">웹사이트 접속 가능 여부</span>,
                  <span className="font-medium text-gray-900"> 응답 시간</span>,
                  <span className="font-medium text-gray-900"> 오류 발생 여부</span>를 종합적으로
                  판단하여 결정됩니다.
                </p>
              </div>
            </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="bg-white/60 rounded-lg p-3">
                    <p className="text-sm font-medium text-gray-800 mb-3">판정 기준</p>
          ...
          <div className="mt-6 bg-gray-50 border border-gray-200 rounded-lg p-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-700 leading-relaxed">
                  서비스 상태는{' '}
                  <span className="font-medium text-gray-900">10분마다 자동으로 확인</span>되며,
                  실제 상황과 다를 수 있습니다. 정확한 정보는
                  <span className="font-medium text-gray-900"> 해당 기관에 직접 문의</span>하시기
                  바랍니다.
                </p>
              </div>
            </div>
